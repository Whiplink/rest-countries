    ...
    <main className='xl:container mx-auto px-5 lg:px-12'>
      ...
      <div className='flex flex-col gap-10 sm:flex-row'>
        ...
        <div className='flex flex-col xl:flex-1 justify-center'>
          <h1 className="mb-5 font-black text-xl md:text-2xl lg:text-3xl">{country.name.common}</h1>
          <div className='flex flex-col gap-10 lg:flex-row mb-10'>
            <div className='flex flex-col gap-3'>
              <p>
                <span className='font-bold'>Native Name: </span><span>{nativeName}</span>
              </p>
              <p>
            ...
            <div className='flex flex-col gap-3'>
              <p>
                <span className='font-bold'>Top Level Domain: </span><span>{country.tld}</span>
              </p>
              <p>
                <span className='font-bold'>Currencies: </span><span>{currencies}</span>
              </p>
              <p>
                <span className='font-bold'>Languages: </span><span>{languages}</span>
              </p>
            </div>
          </div>
          <div>
